...
# TODO: Give this VM a unique IP address from other projects
#       if you want them to be able to run at the same time.
server_ip             = "192.168.62.14"
server_cpus           = "1"   # Cores
...
ruby_version          = "2.1.10" # Choose what ruby version should be installed (will also be the default version)
...
nodejs_version        = "8.9.1"    # By default "latest" will equal the latest stable version
